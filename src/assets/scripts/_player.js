...
export class Player {
  ...
  // seT default value for { noIntervalMatched } options object
  // without it this method will fall if called without parameters (call this method as initializePlayerHTMLControls() will cause an error)
